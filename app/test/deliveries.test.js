...
describe("GET all the deliveries", () => {
    ...
    /**
     * [Express] Test will be successful if the route: (GET) /api/v1/deliveries returns: 400.
     */
    it("[Express] Should return a response code of 400 at: (GET) /api/v1/deliveries", (done) => {
        request(app)
            .get(`/api/v1/deliveries`)
            .set('Accept', 'application/json')
            .expect('Content-Type', /json/)
...
//     /**
//      * [Express] Test will be successful if the route: (POST) /api/v1/deliveries returns: 400.
//      */
//     it("[Express] Should return a response code of 400 at: (POST) /api/v1/deliveries", (done) => {
//         request(app)
//             .get(`/api/v1/deliveries`)
//             .set('Accept', 'application/json')
//             .expect('Content-Type', /json/)
...
//     /**
//      * [Express] Test will be successful if the route: (DELETE) /api/v1/deliveries/:id returns: 400.
//      */
//     it("[Express] Should return a response code of 400 at: (DELETE) /api/v1/deliveries", (done) => {
//         request(app)
//             .del(`/api/v1/deliveries/123`)
//             .set('Accept', 'application/json')
//             .expect('Content-Type', /json/)
